...
Depending on the database, several IDs can be used for the same sample. Please open the document where the [sample metadata information is stored](https://github.com/TeamMacLean/tsl-metagenomics-analysis-workshop/files/PRJNA667299_metadata_truncated.csv). Here, inspect the Run IDs and find out which of them correspond to sample **F_Sample_116**
:::
