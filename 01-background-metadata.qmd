...
![Overview of Metagenomics Workflow](fig/01-01.png)
...
The data we will use during this workshop comes from a study examining the microbiome of healthy and diseased chilli peppers [Gao et al. Microbiome (2021) 9:187](https://microbiomejournal.biomedcentral.com/articles/10.1186/s40168-021-01138-2).
...
2.  In the table [sample metadata](https://github.com/TeamMacLean/tsl-metagenomics-webpage/blob/main/files/PRJNA667299_metadata_truncated.csv) what is the most important piece of metadata collected?
:::
...
Depending on the database, several IDs can be used for the same sample. Please open the document where the [sample metadata information is stored](https://github.com/TeamMacLean/tsl-metagenomics-webpage/blob/main/files/PRJNA667299_metadata_truncated.csv). Here, inspect the Run IDs and find out which of them correspond to sample **F_Sample_116**
:::
...
|---------------|--------------|-----------------|-------------------|
| SRR12773250   | B_Sample_97  | Healthy         | Metabarcoding     |
| SRR12773249   | B_Sample_98  | Healthy         | Metabarcoding     |
| SRR12773248   | B_Sample_99  | Healthy         | Metabarcoding     |
| SRR12773382   | B_Sample_106 | Diseased        | Metabarcoding     |
| SRR12773381   | B_Sample_107 | Diseased        | Metabarcoding     |
| SRR12773380   | B_Sample_108 | Diseased        | Metabarcoding     |

The results of this study, raw sequences, and metadata have been submitted to the NCBI Sequence Read Archive (SRA) and stored in the BioProject [PRJNA667562](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA667562).
