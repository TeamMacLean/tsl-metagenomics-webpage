...
-	We need to consider the size of the region we amplified for QC or merged reads
-	Merging takes FastQ files as input and produce Fasta files as output

:::
## Merging Metabarcode Reads

We will begin by merging our reads into contigs, followed by filtering and trimming of reads based on quality score and several other metrics.
In this experiment, paired-end sequencing of either the V5-V6 region of the 16S rRNA gene or the ITS2 region of the fungal ribosome gene, was performed.  
These regions are around 316 bp and 210 bp in length, respectively.
Our reads average 
