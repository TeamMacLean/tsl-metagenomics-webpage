...
# Exploring Taxonomy {#sec-06-exploring-taxonomy}
...
In this section, we will use Galaxy to run tools normally associated with R, to analyze our microbial samples.
